...
for i in range(world.number_prismatic_joints):
    if i % 2 == 0:
        world.sliders.append(world.create_cube(name="visual_cube" + str(i), parent=world.floor, location=(i/2, i/-2, 0.1), rotation=(radians(90), 0, 0), scale=(0.1, 0.1, 0.8)))
    else:
        world.sliders.append(world.create_cube(name="visual_cube" + str(i), parent=world.floor, location=((i-1)/2, ((i-1)/-2)-1, 0.1), rotation=(0, radians(90), 0), scale=(0.1, 0.1, 0.8)))
